...
public class MainWindow extends JFrame {
    ...
    public MainWindow(Player player, int slot) {
        ...
        appendText("Quiubo bato, bienvenido a rpg chaka\n");
        appendText("Te intersecto: " + enemy.getName());
    }
    ...
    private void initComponents() {
        ...
        // Configuramos el scroll del textDisplay
    ...
    public void checkGameStatus() {
        ...
        if (!player.isAlive()) {
            ...
            appendText("""
                    Le rompiste su mai a %s
                    Has ganado %d puntos de flow
                    Has ganado %d varos
    ...
    private void createEnemy() {
        ...
        if (enemy != null) {
            ...
            appendText("Madres, es: " + enemy.getName() + "\n");
